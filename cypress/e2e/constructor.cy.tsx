const constructorElementTextSelector =
...
describe('Проверка доступности приложения', () => {
  ...
  it('Проверка добавления ингредиентов в конструктор', () => {
    ...
    cy.get(constructorElementTextSelector).contains(
    ...
    cy.get('div.constructor-element span.constructor-element__text').contains(
